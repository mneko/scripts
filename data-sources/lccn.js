...
Discogs.prototype.search = function(query) {
  return result = http().get("http://classify.oclc.org/classify2/Classify?title=" + encodeURIComponent(query));
}
...
Discogs.prototype.barcode = function(code) {
  return result = http().get(" http://classify.oclc.org/classify2/Classify?isbn=" + encodeURIComponent(code));
}
